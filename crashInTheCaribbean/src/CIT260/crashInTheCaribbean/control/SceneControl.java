...
//       
//        SceneType sceneType;
//        for (int i = 0; i < SceneTypeSort.length-1; i++) {
//            for (int j = 0; j < SceneTypeSort.length-1-i; j++) {
//                if (SceneTypeSort[j].getDescription().compareToIgnoreCase(scene[j + 1].getDescription()) > 0) {
//                    sceneType = scene[j];
//                    scene[j] = scene[j+1];
//                    scene[j+1] = sceneType;
//}
